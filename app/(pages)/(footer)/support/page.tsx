		...
		<Accordion variant="light" className="">
			...
			>
				<p className="text-md text-black/90 ml-2">
					To create an account, simply click on the 'Sign Up' button located on
					the top right corner of the website. Fill out the required information
					such as your name, email address, and password, and then click 'Create
					Account'. You will receive a confirmation email to verify your
					account, and once verified, you can log in to access your account
					dashboard.
				</p>
			</AccordionItem>
			...
			>
				<p className="text-md text-black/90 ml-2">
					...
					navigate to the 'Appointments' section, and click on the 'Schedule
					Appointment' button. Choose your preferred date and time, select the
					healthcare provider you wish to see, and confirm your appointment. You
