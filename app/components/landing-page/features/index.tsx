...
export default function Features() {
  return (
    <section
      id="features"
      className="lg:h-4/5 flex flex-col justify-center items-center gap-5 p-5"
    >
      <div className="self-start lg:ml-36">
      ...
      <Card
        // isBlurred
        radius="lg"
        className="lg:h-3/5 lg:w-4/5 flex flex-wrap gap-5 justify-center"
      >
        {projectFeatures.map((item) => (
          <div
            key={item.icon}
            className="lg:h-2/5 lg:w-2/5 p-5 flex  gap-2 justify-center items-cente"
          >
